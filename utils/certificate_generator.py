...
def generate_certificate(certificate: Certificate):
    ...
    font = ImageFont.truetype(font='utils/fonts/rockb.ttf', size=100)
    ...
    font = ImageFont.truetype(font='utils/fonts/rock.ttf', size=70)
    ...
    font = ImageFont.truetype(font='utils/fonts/rockb.ttf', size=50)
    ...
    font = ImageFont.truetype(font='utils/fonts/rockb.ttf', size=45)
